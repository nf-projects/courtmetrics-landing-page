...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        // Merging the color schemes from #2 into the extended section
        tremor: {
          brand: {
          ...
          // Adding dark mode colors from #2
          'dark-tremor': {
            brand: {
              faint: '#0B1229',
      ...
      boxShadow: {
        // Merging boxShadow settings from #2
      ...
      borderRadius: {
        // Merging borderRadius settings from #2
        'tremor-small': '0.375rem',
        'tremor-default': '0.5rem',
        'tremor-full': '9999px',
      },
      fontSize: {
        // Merging fontSize settings from #2
  ...
  safelist: [
    // Including safelist patterns from #2
    {
